...
class HomeFragment : Fragment() {
    ...
    private fun onPopularItemLongClick() {
        ...
        popularItemAdapter.onLongItemClick = { meal ->
            ...
            val meal_BottomSheetFragment = mealBottomSheetFragment.newInstance(meal.idMeal)
            meal_BottomSheetFragment.show(childFragmentManager,"Meal info ")
    ...
    private fun onCategoryClick() {
        ...
        categoriesAdapter.onItemClick = { category ->
            ...
            val intent1 = Intent(activity,CategoryMealsActivity::class.java)
            intent1.putExtra(CATEGORY_NAME , category.strCategory)
    ...
    private fun observerItemLiveData(){

        viewModel.observePopularItemLiveData().observe(viewLifecycleOwner,
        ) { mealList ->

            popularItemAdapter.setMeal(meal_list = mealList as ArrayList<MealByCategory>)
        }
